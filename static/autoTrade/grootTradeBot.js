...
function commonMarkupPlaceHolder() {
    ...
    html += '9:15 CLOSE [INDEX,WEIGHTAGE STOCKS]<input  type="checkbox" class="checks-before-trades">'
    html += '</div>'
    html += '<div class="col-md-2">'
    html += '9:15 ASO/BSO<input  type="checkbox" class="checks-before-trades">'
    html += '</div>'
    html += '<div class="col-md-1">'
    html += 'ADR<input  type="checkbox" class="checks-before-trades">'
    html += '</div>'
    html += '<div class="col-md-1">'
    html += 'OI/OTM OI<input  type="checkbox" class="checks-before-trades">'
    html += '</div>'
    html += '<div class="col-md-2">'
    html += 'OBV/OTM OBV<input  type="checkbox" class="checks-before-trades">'
    html += '</div>'
    html += '<div class="col-md-1">'
    html += 'SCORE<input  type="checkbox" class="checks-before-trades">'
    html += '</div>'
    html += '<div class="col-md-1">'
    html += '# ASO/BSO<input  type="checkbox" class="checks-before-trades">'
    html += '</div>'
    html += '<div class="col-md-1">'
    html += 'CRUDE OIL<input  type="checkbox" class="checks-before-trades">'
    html += '</div>'
    html += '<div class="col-md-1">'
    html += 'GIFT NIFTY<input  type="checkbox" class="checks-before-trades">'
    html += '</div>'
    html += '</div>'

    html += '<div class="px-3 border-bottom mb-2"></div>'
